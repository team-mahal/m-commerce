<section id="checkout-personal-information-step" class="checkout-step -reachable -complete -current js-current-step">
                        ...
                        <div class="content bg-white p-3">
                            ...
                            <ul class="nav nav-inline m-y-2">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " data-link-action="show-login-form" data-toggle="tab" href="#checkout-login-form" role="tab">
							          Sign in
							        </a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="checkout-guest-form" role="tabpanel">
                                    ...
                                    <form action="https://demo.fieldthemes.com/ps_medicine/home2/en/order" id="customer-form" class="js-customer-form" method="post">
                                        <section>

                                            <input type="hidden" name="id_customer" value="49">
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" name="firstname" type="text" value="sdf" required="">
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" name="lastname" type="text" value="sdf" required="">
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" name="email" type="email" value="sdfdsf@gmail.com" required="">
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" name="birthday" type="text" value="05/31/1970" placeholder="MM/DD/YYYY">
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <span class="custom-checkbox">
                                                        ...
                                                        <br><em>You may unsubscribe at any moment. For that purpose, please find our contact info in the legal notice.</em></label>
                                                    </span>
                                ...
                                <div class="tab-pane " id="checkout-login-form" role="tabpanel">
                                    ...
                                    <form id="login-form" action="https://demo.fieldthemes.com/ps_medicine/home2/en/order" method="post">
